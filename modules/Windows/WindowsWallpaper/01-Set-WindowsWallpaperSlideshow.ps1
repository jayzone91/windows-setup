$script:WindowsSetupSourceRoot_modules_Windows_WindowsWallpaper = Split-Path -Parent $PSScriptRoot
...
function Set-WindowsWallpaperSlideshow {
    ...
    $windowsSetupRoot = Split-Path `
        -Path (Split-Path -Path $script:WindowsSetupSourceRoot_modules_Windows_WindowsWallpaper -Parent) `
        -Parent
