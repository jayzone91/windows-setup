import type { KomorebiWindow } from "zebar";

import { zebar } from "../zebar";

const iconCache = new Map<string, Promise<string | null>>();

export function getWindowIcon(window: KomorebiWindow): Promise<string | null> {
...
async function loadWindowIcon(executableName: string): Promise<string | null> {
  const command = `
